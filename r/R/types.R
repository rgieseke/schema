...
#' @return A `list` of class `Union` describing valid subtypes of this type
#' @export
InlineContent <- Union("NULL", "logical", "numeric", "character", Cite, CiteGroup, CodeExpression, CodeFragment, Delete, Emphasis, ImageObject, Link, MathFragment, NontextualAnnotation, Quote, Strong, Subscript, Superscript)
